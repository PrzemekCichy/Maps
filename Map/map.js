...
var D3Helper = /** @class */ (function () {
    ...
    D3Helper.prototype.drawGridAndGroundMask = function () {
        this.drawPolygon(this.svgGroups.groundOverlay, [
            { x: 0, y: 1400 },
            { x: 2700, y: 0 },
            { x: 5400, y: 1400 },
            { x: 2700, y: 2800 },
...
var RpgMap = /** @class */ (function () {
                ...
                test: function (property, index) {
                    ...
                    if (property == "drawEnabledValue") {
                        ...
                        var list1 = d3
                            ...
                            .attr("stroke-width", renderOptions[index].strokeSlider.value.toString());
                    }
    ...
    RpgMap.prototype.render = function (map_id, preserveSvg) {
        ...
        (function () {
            ...
            (_a = computed_mob_locations[map_id]) === null || _a === void 0 ? void 0 : _a.forEach(function (center, index) {
